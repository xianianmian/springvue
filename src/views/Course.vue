    ...
    <el-dialog title="课程信息" :visible.sync="dialogFormVisible" width="30%">
      <el-form label-width="80px" size="small">
        ...
        <el-form-item label="老师id">
          <el-select clearable v-model="form.teachId" placeholder="请选择" style="width: 100%;">
          <el-option v-for="item in teachers" :key="item.id" :lable="item.nickname" :value="item.id">
            <i :class="item.value"/>{{item.nickname}}
          </el-option>
          </el-select>
        </el-form-item>
